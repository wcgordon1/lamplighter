...
{
  "chapter": 1,
  "timeline": "Day -12, Night",
  "onstage": ["ivy", "june", "button"],
  "locations": ["rowhouse_lane"],
  "seam_level": 1,
  "cadence_used": null,
  "cadence_counts": null,
  "props_moved": ["brass_transit_token: doorframe_crack → Ivy's_pocket → cord_around_neck", "salt_tin: noted_at_June's_door"],
  "new_facts": ["Ivy arrives at Aunt June's rowhouse", "Door lamp holds steady in wind", "House hums with low vibration until token removed", "Salt scattered across threshold deliberately", "Token found in doorframe crack, stamped with precise lantern", "One-eyed dog refuses to cross salt line, keeps vigil", "June works alterations, lives alone with careful order", "Token warms beyond ambient temperature", "House settles when Ivy crosses threshold with token"],
  "callbacks": ["token warmth suggests cadence resonance", "salt threshold pattern", "steady lamplight vs. typical flicker"],
  "open_threads": ["Who left the token?", "Why do thresholds need salt?", "What is dog waiting for?", "What really happened to Ivy's mother?", "Why does token warm to Ivy's touch?"],
  "next_hooks": ["Dog's continued vigil", "Token's purpose and connection to mother", "House's acceptance of Ivy", "June's careful secrets"]
}
```